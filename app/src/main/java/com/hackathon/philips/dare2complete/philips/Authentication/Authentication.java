package com.hackathon.philips.dare2complete.philips.Authentication;
...
import com.hackathon.philips.dare2complete.philips.MainActivity;
...
public class Authentication extends AppCompatActivity {
    ...
    EditText login_email, login_password, signup_email, signup_password, signup_confpassword, signup_name, signup_mobile;
    ...
    public void signupUser(View view){
        ...
        if(!email.isEmpty() && !pass.isEmpty() && !name.isEmpty()){
            if(!confpass.isEmpty() && imageAttached){
                if (confpass.equals(pass)){
                    signUp(email, pass, name, mob);
                }
                else {
    ...
    private void signUp(String email, String pass, final String name, final String mob) {
